<div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/items/register_item">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="text" id="used_in" class="form-control" required placeholder="Experimento em que é utilizado">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <select class="form-select" id="container_type" required>
                                <option value="" selected>--</option>
                        ...
                        <div class="col mb-4">
                            ...
                            <input type="number" id="volume" class="form-control" required placeholder="0.00">
                        </div>


                        <div class="col mb-4">
                            <label for="unit_type" class="form-label">Medida</label>
                            <select class="form-select" id="unit_type" required>
                                <option value="" selected>--</option>
                    ...
                    <div class="row">
                        <div class="col mb-4">
                            ...
                            <input type="text" id="brand_name" class="form-control" required placeholder="Digite o nome da marca">
                        </div>

                        <div class="col mb-4">
                            <label for="quantity_in_stock" class="form-label">Quantidade no estoque</label>
                            <input type="number" id="quantity_in_stock" class="form-control" required placeholder="0">
                        </div>
                    </div>
                </div>
