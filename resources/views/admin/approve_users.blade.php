                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display: flex; flex-direction: row; gap: 15px;">
                            <form method="POST" id="approve{{ $user->id }}" action="/admin/accept/{{ $user->id }}" enctype='multipart/form-data'>
                                @csrf
                            ...
                            <form method="POST" id="decline{{ $user->id }}" action="/admin/decline/{{ $user->id }}" enctype='multipart/form-data'>
                                @csrf
